...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commit.parent'
        db.add_column(u'analysis_commit', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['analysis.Commit'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commit.parent'
        db.delete_column(u'analysis_commit', 'parent_id')
