...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Author'
        db.create_table(u'analysis_author', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['analysis.GithubUser'], null=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'analysis', ['Author'])

        # Adding field 'Commit.author'
        db.add_column(u'analysis_commit', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['analysis.Author']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Author'
        db.delete_table(u'analysis_author')

        # Deleting field 'Commit.author'
        db.delete_column(u'analysis_commit', 'author_id')
