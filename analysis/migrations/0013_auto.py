...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'analysis_organization_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organization', models.ForeignKey(orm[u'analysis.organization'], null=False)),
            ('githubuser', models.ForeignKey(orm[u'analysis.githubuser'], null=False))
        ))
        db.create_unique(m2m_table_name, ['organization_id', 'githubuser_id'])


    def backwards(self, orm):
        # Removing M2M table for field users on 'Organization'
        db.delete_table(db.shorten_name(u'analysis_organization_users'))
    ...
    models = {
        ...
        u'analysis.organization': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'organization'", 'symmetrical': 'False', 'to': u"orm['analysis.GithubUser']"})
        },
