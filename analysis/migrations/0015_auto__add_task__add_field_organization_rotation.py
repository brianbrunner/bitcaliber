...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Task'
        db.create_table(u'analysis_task', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='created_tasks', to=orm['analysis.GithubUser'])),
            ('assigned_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assigned_tasks', to=orm['analysis.GithubUser'])),
        ...
        db.send_create_signal(u'analysis', ['Task'])

        # Adding field 'Organization.rotation'
        db.add_column(u'analysis_organization', 'rotation',
    ...
    def backwards(self, orm):
        # Deleting model 'Task'
        db.delete_table(u'analysis_task')

        # Deleting field 'Organization.rotation'
        db.delete_column(u'analysis_organization', 'rotation')
    ...
    models = {
        ...
        u'analysis.organization': {
            ...
            'rotation': ('jsonfield.fields.JSONField', [], {}),
        ...
        u'analysis.task': {
            ...
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'assigned_tasks'", 'to': u"orm['analysis.GithubUser']"}),
            'commit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['analysis.Commit']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'created_tasks'", 'to': u"orm['analysis.GithubUser']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
